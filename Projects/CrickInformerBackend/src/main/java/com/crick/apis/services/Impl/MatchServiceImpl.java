...
import com.crick.apis.repositories.MatchRepository;
    ...
    public List<Match> getLiveMatches() {
        ...
        try {
            ...
            for (Element match : liveScoreElements) {
                ...
                match1.setBollTeam(bowlTeam);
                match1.setBollTeamScore(bowlTeamScore);
...
//                update the match in database
    ...
    private void updateMatchInDb(Match match1) {
        Match match=matchRepository.findByTeamHeading(match1.getTeamHeading());
        if (match==null){
